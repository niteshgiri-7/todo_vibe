...
const Form = () => {
  return (
    <div className="flex bg- w-screen h-screen">
      <div className="bg-green-300 h-full w-[50%] ">
        <img className="w-full h-full" src="/homeHero.jpg" alt="homeImg"/>
      </div>
      <div className="bg- w-[50%] flex justify-center p-8">
        <div className="bg- w-auto max-w-[60%] h-[80%] flex flex-col  py-8 mt-[15%] px-4">
          ...
          <form className="mt-8">
            ...
            <div className=" w-[97%] flex justify-between mx-2 py-4">
              <div>
                <input type="radio" value="Remember me" name="Remember me" className="hover:cursor-pointer"/>
                <label className="px-2 font-semibold">Remember me</label>
              </div>
              <span className="underline text-gray-500 hover:cursor-pointer">Forgot Password?</span>
            </div>
            <button className="w-full bg-[#ed510f] px-2 py-4 font-bold text-white rounded-3xl">Sign In</button>
          </form>
        ...
        <button className=" border border-gray-300 px-2 py-4 mt-4 font-bold text-black rounded-3xl w-full flex justify-center">
          <img className="mr-2 h-[30px] w-[30px] rounded-lg" src="/google-Logo.png" alt="googleLogo"></img>
          <span>Google</span>
        </button>
        <button className="border border-gray-300 bg px-2 py-4 mt-4 font-bold text-black rounded-3xl w-full flex justify-center">
          <img className="mr-2 h-[25px] w-[25px]" src="/appleLogo.png" alt="googleLogo"></img>
          <span>Apple</span>
        </button>
        <div className="text-center mt-4">
        <span>Don't have an account? <span className="text-[#ed510f] font-bold underline hover:cursor-pointer"> Sign Up now</span></span>
